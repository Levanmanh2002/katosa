...
public class NuAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    Context context;
    ...
    public NuAdapter(Context context, List<SanPhamMoi> array) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        if(viewType == VIEW_TYPE_DATA){
            View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_donu, parent, false);
