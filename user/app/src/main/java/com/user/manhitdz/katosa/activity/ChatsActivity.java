...
import com.user.manhitdz.katosa.adapter.ChatAdapter;
import com.user.manhitdz.katosa.model.ChatMessage;
...
public class ChatsActivity extends AppCompatActivity {
        ...
        if (value != null){
            ...
            for (DocumentChange documentChange : value.getDocumentChanges()){
                if (documentChange.getType() == DocumentChange.Type.ADDED){
                    ...
                    chatMessage.receivendid = documentChange.getDocument().getString(Utils.RECEIVEDID);
    ...
    private void sendMessToFire() {
        ...
        if (TextUtils.isEmpty(str_mess)){
            Toast.makeText(getApplicationContext(), "Trống", Toast.LENGTH_LONG).show();
        }else {
