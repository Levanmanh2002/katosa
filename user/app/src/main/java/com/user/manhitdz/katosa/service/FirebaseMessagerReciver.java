package com.user.manhitdz.katosa.service;
...
import com.user.manhitdz.katosa.activity.MainActivity;
...
public class FirebaseMessagerReciver extends FirebaseMessagingService {
    ...
    private RemoteViews customView(String title, String body){
        ...
        remoteViews.setImageViewResource(R.id.imgnoti, R.drawable.ic_notifications_active);
        return remoteViews;
    }
}
