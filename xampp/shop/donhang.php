...
if($data == true){
	...
	if(!empty($iddonhang)){
		...
		foreach ($chitiet as $key => $value) {
			$truyvan = 'INSERT INTO `chitietdonhang`(`iddonhang`, `idsp`, `soluong`, `gia`, `size`, `color`) VALUES ('.$iddonhang["iddonhang"].','.$value["idsp"].','.$value["soluong"].','.$value["giasp"].',"'.$value["size"].'","'.$value["color"].'")';
